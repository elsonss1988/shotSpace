...
const aliensImg=['../img/monster-1.png','../img/monster-1.png','../img/monster-1.png']
...
function moveLaser(laser){
    let laserInterval=setInterval(()=>{
        ...
        aliens.forEach(alien=>{
            if(checkLaserColisition(laser,alien)){
...
function checkLaserColisition(laser,alien){
...
function playGame(){
    ...
    window.addEventListener('keydo{wn',flyShip);
